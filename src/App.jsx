              ...
              <SectionCard
                ...
                moreButton={
                  stockPreview.total > 3 && (
                    <SeeAllButton count={stockPreview.total - stockPreview.list.length} onClick={() => { setStockFilter("all"); setView("stock"); }} />
                  )
                }
              />
              ...
              <SectionCard
                ...
                moreButton={
                  toBuyPreview.total > 3 && (
                    <SeeAllButton count={toBuyPreview.total - toBuyPreview.list.length} onClick={() => { setTobuyFilter("pending"); setView("tobuy"); }} />
                  )
                }
              />
              ...
              <SectionCard
                ...
                moreButton={
                  agendaPreview.total > 3 && (
                    <SeeAllButton count={agendaPreview.total - agendaPreview.list.length} onClick={() => { setAgendaFilter("all"); setView("agenda"); }} />
                  )
                }
              />
            </div>
...
function SeeAllButton({ count, onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-center gap-1 pt-2 pb-0 text-sm font-semibold"
